                ...
                <div class="card shadow-sm mb-5 border-0">
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between align-items-center border-bottom pb-2 mb-3">
                            <h3 class="text-dark mb-0 fw-bold"><?= htmlspecialchars($p['titulo']) ?></h3><a href="editar_publicacion.php?id=<?= htmlspecialchars($p['id']) ?>" class="btn btn-warning btn-sm fw-bold">Edit</a>
